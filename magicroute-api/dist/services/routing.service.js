...
exports.parseHora = parseHora;
exports.parseHoraRaw = parseHoraRaw;
exports.calcularDistancia = calcularDistancia;
exports.estimarTempoViagemMinutos = estimarTempoViagemMinutos;
exports.calcularCronograma = calcularCronograma;
exports.ordenarPorJanelasDeTempo = ordenarPorJanelasDeTempo;
// ─── Helpers ─────────────────────────────────────────────────────
/**
 ...
 */
function estimarTempoViagemMinutos(distanciaKm) {
 ...
 */
function calcularCronograma(rota, horaSaidaMinutos, tempoAtendimentoMinutos, origemLat, origemLng) {
...
function otimizar2Opt(rotaInicial, horaSaidaMinutos, tempoAtendimentoMinutos, origemLat, origemLng) {
...
// ─── Algoritmo Principal ────────────────────────────────────────
function ordenarPorJanelasDeTempo(entregas, horaSaida, tempoAtendimento, origemLat, origemLng) {
    const horaSaidaMinutos = parseHora(horaSaida) ?? 480;
    const processadas = entregas.map(e => ({
        ...e,
